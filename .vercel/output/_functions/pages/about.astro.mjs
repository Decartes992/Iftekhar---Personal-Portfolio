...
</p> </div> </section>  <section class="py-16 bg-white dark:bg-bg-dark"> <div class="container mx-auto px-4"> <div class="flex flex-col md:flex-row items-center md:items-start gap-8"> <img src="/images/iftekhar_photo.jpg" alt="Iftekhar Hossain Rafi" class="w-48 h-48 rounded-full object-cover shadow-lg ring-4 ring-primary/20"> <div> <p class="text-lg mb-4">Hello! I'm Iftekhar Hossain Rafi, an Electrical Engineering student at Dalhousie University with a strong focus on the Computer Engineering option. I'm passionate about the intersection of hardware and software, with hands-on experience in software development (Python, C/C++), embedded systems programming, and system architecture.</p> <p class="text-lg mb-4">My academic journey and project work, such as contributing as a core software developer for the Dalhousie Space Systems Lab's LORIS satellite project and working on the MILTON AI-powered training decisions application, have allowed me to develop practical skills in areas like data structures, algorithms, API development, and working with tools like Git, Docker, and Linux.</p> <p class="text-lg mb-4">Previously, as a Makerspace Coordinator at Dalhousie's Emera Ideahub, I enjoyed advising students on diverse engineering projects and maintaining a variety of advanced equipment.</p> <p class="text-lg mb-4">I am actively seeking opportunities where I can apply my skills in software engineering, systems development, and electrical engineering to contribute to innovative projects.</p> </div> </div> </div> </section>  ${renderComponent($$result2, "SectionDivider", SectionDivider, { "client:load": true, "type": "wave", "position": "bottom", "color": "bg-gray-50 dark:bg-gray-900", "height": 60, "bgColor": "", "flipX": false, "width": 100, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SectionDivider.jsx", "client:component-export": "default" })}  <section class="py-16 bg-gray-50 dark:bg-gray-900"> <div class="container mx-auto px-4"> <h2 class="text-3xl font-bold text-center mb-12">Technical Skills</h2> <div class="max-w-3xl mx-auto"> ${renderComponent($$result2, "SkillRadarChart", SkillRadarChart, { "client:visible": true, "skills": skillsData, "primaryColor": "rgb(59, 130, 246)", "backgroundColor": "rgba(59, 130, 246, 0.1)", "height": 400, "animationDuration": 1500, "showLegend": true, "client:component-hydration": "visible", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SkillRadarChart.jsx", "client:component-export": "default" })} </div> </div> </section>  ${renderComponent($$result2, "SectionDivider", SectionDivider, { "client:load": true, "type": "triangles", "position": "top", "color": "bg-white dark:bg-bg-dark", "height": 60, "bgColor": "", "flipX": false, "width": 100, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SectionDivider.jsx", "client:component-export": "default" })}  <section class="py-16 bg-white dark:bg-bg-dark"> <div class="container mx-auto px-4"> <h2 class="text-3xl font-bold text-center mb-12">Professional Journey</h2> <div class="max-w-4xl mx-auto"> ${renderComponent($$result2, "AnimatedTimeline", AnimatedTimeline, { "client:visible": true, "items": experienceData, "layout": "vertical", "alternating": true, "lineColor": "#3B82F6", "accentColor": "#3B82F6", "client:component-hydration": "visible", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/AnimatedTimeline.jsx", "client:component-export": "default" })} </div> </div> </section>  <section class="py-16 bg-gray-50 dark:bg-gray-900"> <div class="container mx-auto px-4"> <h2 class="text-3xl font-bold text-center mb-8">Education</h2> <div class="max-w-2xl mx-auto"> <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md"> <h3 class="text-xl font-bold mb-2">Bachelor of Electrical Engineering</h3> <p class="text-gray-700 dark:text-gray-300 mb-1">Dalhousie University</p> <p class="text-gray-600 dark:text-gray-400 mb-4">Computer Engineering Option, Graduating 2025</p> <p class="text-gray-700 dark:text-gray-300">
...
}, "/workspaces/Iftekhar---Personal-Portfolio/src/pages/about.astro", void 0);

const $$file = "/workspaces/Iftekhar---Personal-Portfolio/src/pages/about.astro";
const $$url = "/about";
