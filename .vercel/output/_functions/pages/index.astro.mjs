/* empty css                                 */
import { c as createComponent, a as createAstro, m as maybeRenderHead, e as renderScript, b as renderTemplate, d as addAttribute, r as renderComponent } from '../chunks/astro/server_Du6cOOQ1.mjs';
import 'kleur/colors';
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Iftekhar Rafi - Portfolio", "description": "Personal portfolio showcasing projects and skills in programming." }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="relative"> ${renderComponent($$result2, "ParticleBackground", ParticleBackground, { "client:load": true, "color": "59, 130, 246", "particleDensity": 8, "opacity": 0.2, "mouseInteract": true, "maxConnectDistance": 150, "minSize": 1, "maxSize": 3, "minSpeed": 0.3, "maxSpeed": 0.8, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/ParticleBackground.jsx", "client:component-export": "default" })} ${renderComponent($$result2, "Hero", $$Hero, { ...heroData })} </div>  ${renderComponent($$result2, "SectionDivider", SectionDivider, { "client:load": true, "type": "wave", "position": "bottom", "color": "bg-white dark:bg-bg-dark", "bgColor": "", "flipX": false, "height": 60, "width": 100, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SectionDivider.jsx", "client:component-export": "default" })}  <section class="py-16 bg-gray-50 dark:bg-gray-900"> <div class="container mx-auto px-4"> <h2 class="section-title text-center mb-12">At a Glance</h2> ${renderComponent($$result2, "AnimatedStatsCounter", AnimatedStatsCounter, { "client:visible": true, "stats": stats, "bgColor": "bg-white dark:bg-gray-800", "textColor": "text-primary", "duration": 2e3, "client:component-hydration": "visible", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/AnimatedStatsCounter.jsx", "client:component-export": "default" })} </div> </section>  ${renderComponent($$result2, "About", $$About, {})}  ${renderComponent($$result2, "SectionDivider", SectionDivider, { "client:load": true, "type": "curve", "position": "top", "color": "bg-white dark:bg-bg-dark", "bgColor": "", "flipX": false, "height": 60, "width": 100, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SectionDivider.jsx", "client:component-export": "default" })}  ${renderComponent($$result2, "ProjectsSection", $$ProjectsSection, {})}  ${renderComponent($$result2, "SectionDivider", SectionDivider, { "client:load": true, "type": "triangles", "position": "top", "color": "bg-white dark:bg-bg-dark", "bgColor": "", "flipX": false, "height": 60, "width": 100, "client:component-hydration": "load", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/SectionDivider.jsx", "client:component-export": "default" })}  <section id="contact" class="py-16 bg-gray-50 dark:bg-gray-900"> <div class="container mx-auto px-4"> <h2 class="section-title text-center mb-12">Get In Touch</h2> <div class="max-w-2xl mx-auto"> ${renderComponent($$result2, "ContactForm", ContactForm, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "/workspaces/Iftekhar---Personal-Portfolio/src/components/ContactForm.jsx", "client:component-export": "default" })} </div> </div> </section> ` })}`;
